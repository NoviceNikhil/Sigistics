...
const UserSignup = () => {
  ...
  const isFormValid = form.name && form.email && form.phone && form.phone.length > 10 && form.password && confirmPassword && (form.password === confirmPassword) && !emailError && !phoneError && isPasswordStrong;
  ...
  return (
    <AuthLayout title="Join Us" subtitle="New User Signup">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <PasswordStrengthInput
            ...
            onStrongChange={setIsPasswordStrong}
            required
        ...
        <p className="text-center tracking-tight text-sm text-muted-foreground mt-4">
